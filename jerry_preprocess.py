...
# ID2FORMULA从的json格式
with open('Jerry/JerryRealData/ID2FORMULA.json', 'r') as file:
...
class JerryPreprocessBuild():
    def __init__(self, root='./Jerry/JerryRealData', name2id=NAME2ID, id2formula=ID2FORMULA, originImgsPath='/Users/mazeyu/Downloads/dataset/output'):
        """
        从头构建一个数据集
